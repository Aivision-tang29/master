...
class ConvNet(object):
    ...
    def inference(self):
        ...
        drop_out = tf.layers.dropout(fc,
                                     self.keep_prop,
                                     training=self.training,
                                     name='drop_out')
        self.logits = tf.layers.dense(drop_out, self.n_class, name='logits')
    ...
    def train(self, n_epochs):
        ...
        with tf.Session() as sess:
            ...
            ckpt = tf.train.get_checkpoint_state(os.path.dirname('checkpoints/convnet_layers/checkpoints'))
